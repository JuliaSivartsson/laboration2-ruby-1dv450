...
Restaurant.create([{name: "Itzy's place", message: "Jävligt snygg restaurang", rating: 4, position_id: 1, creator_id: 1}, 
                {name: "Mammas mat!", message: "Världens bästa!", rating: 5, position_id: 1, creator_id: 1},
                {name: "Anubis bistro", message: "Katten med klös", rating: 5, position_id: 1, creator_id: 1}])
